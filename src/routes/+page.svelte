	...
	<a class="card card-hover overflow-hidden" href="#">
		...
		<div class="p-4 space-y-4">
			...
			<article>
				<p>
					<!-- cspell:disable -->
					This is the article blurb. Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam aspernatur provident eveniet eligendi cumque consequatur tempore
